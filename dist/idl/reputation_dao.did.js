export const idlFactory = ({ IDL }) => {
    ...
    const ReputationChild = IDL.Service({
        ...
        'awardRep': IDL.Func([IDL.Principal, IDL.Nat, IDL.Opt(IDL.Text)], [IDL.Text], []),
        'awarderStats': IDL.Func([IDL.Principal], [IDL.Vec(AwarderBreakdown)], ['query']),
        'blacklist': IDL.Func([IDL.Principal, IDL.Bool], [IDL.Text], []),
        'configureDecay': IDL.Func([IDL.Nat, IDL.Nat, IDL.Nat, IDL.Nat, IDL.Bool], [IDL.Text], []),
        'cycles_balance': IDL.Func([], [IDL.Nat], ['query']),
        'emitEvent': IDL.Func([IDL.Text, IDL.Vec(IDL.Nat8)], [IDL.Text], []),
        'findTransactionsByReason': IDL.Func([IDL.Text, IDL.Nat], [IDL.Vec(Transaction)], ['query']),
        'getBalance': IDL.Func([IDL.Principal], [IDL.Nat], ['query']),
        'getBalanceWithDetails': IDL.Func([IDL.Principal], [
            IDL.Record({
                'rawBalance': IDL.Nat,
        ...
        'getTopUpsPaged': IDL.Func([IDL.Nat, IDL.Nat], [IDL.Vec(TopUp)], ['query']),
        ...
        'getTransactionsByUser': IDL.Func([IDL.Principal], [IDL.Vec(Transaction)], ['query']),
        'getTransactionsPaged': IDL.Func([IDL.Nat, IDL.Nat], [IDL.Vec(Transaction)], ['query']),
        'getTrustedAwarders': IDL.Func([], [IDL.Vec(Awarder)], ['query']),
        'getUserDecayInfo': IDL.Func([IDL.Principal], [IDL.Opt(UserDecayInfo)], ['query']),
        'health': IDL.Func([], [
            IDL.Record({
                'topUpCount': IDL.Nat,
        ...
        'leaderboard': IDL.Func([IDL.Nat, IDL.Nat], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Nat))], ['query']),
        'multiAward': IDL.Func([
            IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Nat, IDL.Opt(IDL.Text))),
            IDL.Bool,
        ], [IDL.Text], []),
        'myStats': IDL.Func([IDL.Principal], [
            IDL.Record({
        ...
        'revokeRep': IDL.Func([IDL.Principal, IDL.Nat, IDL.Opt(IDL.Text)], [IDL.Text], []),
        ...
        'setPerAwarderDailyLimit': IDL.Func([IDL.Principal, IDL.Nat], [IDL.Text], []),
